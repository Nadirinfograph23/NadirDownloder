...
# Platforms that need yt-dlp to download (yt-dlp saves to /tmp then streams).
# Facebook uses fdown.net scraping in download.py and direct CDN streaming
# in the proxy — yt-dlp cannot parse Facebook pages from server environments.
